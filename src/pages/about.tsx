...
const About: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className={`ip-container relative w-full min-h-screen bg-[#191919] font-['Montserrat'] ${loaded ? 'loaded' : 'loading'}`}>
        {/* Initial loader */}
                  ...
                  <OwlCarousel className="owl-carousel owl-theme" items={1} loop nav margin={10}>
                    <div className="item">
                      <div className="feature-post pr-[212px] overflow-hidden pb-[31px] md:flex">
                        ...
                        <div className="feature-post-content md:w-[50%] p-4">
                          <span className="block text-white text-[15px] font-['Montserrat'] font-light leading-[26px] m-0 mb-[16px]">our specialty</span>
                    ...
                    <div className="item">
                      <div className="feature-post pr-[212px] overflow-hidden pb-[31px] md:flex">
                        ...
                        <div className="feature-post-content md:w-[50%] p-4">
                          <span className="block text-white text-[15px] font-['Montserrat'] font-light leading-[26px] m-0 mb-[16px]">planings</span>
                    ...
                    <div className="item">
                      <div className="feature-post pr-[212px] overflow-hidden pb-[31px] md:flex">
                        ...
                        <div className="feature-post-content md:w-[50%] p-4">
                          <span className="block text-white text-[15px] font-['Montserrat'] font-light leading-[26px] m-0 mb-[16px]">lot of features</span>
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-1/2 p-4">
                      <div className="title-box">
                        <span className="block text-white text-[15px] font-['Montserrat'] font-light leading-[26px] m-0 mb-[16px]">Firm of The Year</span>
                      ...
                      <div className="services-post6 flex mb-4">
                        ...
                        <div className="serv-content">
                          ...
                          <p className="text-[rgba(255,255,255,0.8)] text-[15px] font-['Montserrat'] font-light leading-[26px] m-0">Creamos diseños arquitectónicos únicos que establecen nuevas tendencias. Cada proyecto refleja la visión de nuestros clientes con soluciones contemporáneas y funcionales.</p>
                        </div>
                      </div>
                      <div className="services-post6 flex mb-4">
                        <div className="icon mr-4">
                        ...
                        <div className="serv-content">
                          ...
                          <p className="text-[rgba(255,255,255,0.8)] text-[15px] font-['Montserrat'] font-light leading-[26px] m-0">Priorizamos la comodidad en cada dimensión del espacio. Desde iluminación natural hasta flujo de aire, cada detalle arquitectónico es calculado para optimizar la experiencia del usuario.</p>
                        </div>
                      </div>
                      <div className="services-post6 flex mb-4">
                        <div className="icon mr-4">
                        ...
                        <div className="serv-content">
                          ...
                          <p className="text-[rgba(255,255,255,0.8)] text-[15px] font-['Montserrat'] font-light leading-[26px] m-0">Cada proyecto comienza con planificación exhaustiva. Analizamos contextos, normativas y necesidades específicas para crear soluciones arquitectónicas estratégicas y sostenibles.</p>
                        </div>
                      </div>
                    </div>
                    <div className="w-full lg:w-1/2 p-4">
