...
const PageBanner: React.FC = () => {
  return (
    <section className="page-banner-section py-2 lg:py-[200px] pb-1 lg:pb-[100px] text-center bg-cover bg-center" style={{ backgroundImage: "url('/images/renderplay/renderplayportada.webp')" }}>
